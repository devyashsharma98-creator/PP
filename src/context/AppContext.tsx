...
const defaultPermissions: AppPermissionSummary = {
  ...
  canReviewEvent: false,
  canPublishEvent: false,
  canCancelEvent: false,
  canManageEventForm: false,
  ...
  canArchiveArticle: false,
  canUpdatePrachar: false,
  canViewPracharReport: false,
  ...
  canUpdateTask: false,
  canAssignTask: false,
  canCreateCircular: false,
  canBroadcastCircular: false,
