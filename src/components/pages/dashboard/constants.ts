...
export const SUGGESTIONS: { question: string; questionHi: string; type: 'text' | 'yesno' }[] = [
...
type ChecklistKey = 'designing' | 'food' | 'seating' | 'transport' | 'accommodation' | 'soundMic' | 'camera' | 'screen' | 'lights';
...
export const eventTemplates: Record<string, { labelEn: string; labelHi: string; checklist: ChecklistKey[] }> = {
  seminar: {
