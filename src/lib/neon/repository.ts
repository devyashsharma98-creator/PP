...
function buildViewer(ctx: NeonAuthContext): AppViewerContext {
  ...
  return {
    ...
    permissions: {
      ...
      canUpdateEvent: hasAny(managerRoles),
      canSubmitEvent: hasAny(managerRoles),
      canReviewEvent: hasAny(publishRoles),
      canPublishEvent: hasAny(publishRoles),
      canCancelEvent: hasAny(publishRoles),
      canManageEventForm: hasAny(managerRoles),
      canManagePolls: hasAny(managerRoles),
      canFinalizePoll: hasAny(publishRoles),
      canViewRegistrations: hasAny(managerRoles),
      canCreateArticle: hasAny(managerRoles),
      canUpdateArticle: hasAny(managerRoles),
      canSubmitArticle: hasAny(managerRoles),
      canReviewArticle: hasAny(managerRoles),
      canPublishArticle: hasAny(publishRoles),
      canArchiveArticle: hasAny(publishRoles),
      canUpdatePrachar: hasAny(publishRoles),
      canViewPracharReport: hasAny(publishRoles),
      canManageUsers: hasAny(["super_admin", "org_admin"]),
      canAssignRoles: hasAny(["super_admin", "org_admin"]),
      canViewDirectory: hasAny(managerRoles),
      canCreateProject: hasAny(managerRoles),
      canUpdateProject: hasAny(managerRoles),
      canCreateTask: hasAny(managerRoles),
      canUpdateTask: hasAny(managerRoles),
      canAssignTask: hasAny(managerRoles),
      canCreateCircular: hasAny(publishRoles),
      canBroadcastCircular: hasAny(["super_admin", "org_admin", "vibhag_pramukh", "prant_sanyojak"]),
      canManageVolunteers: hasAny(managerRoles),
      canLogActivity: hasAny(managerRoles),
      canUploadMedia: hasAny(managerRoles),
      canDeleteMedia: hasAny(managerRoles),
      canManageMediaLibrary: hasAny(managerRoles),
      canCreateConference: hasAny(managerRoles),
      canManageConference: hasAny(managerRoles),
      canManageConferenceSessions: hasAny(managerRoles),
      canManageConferenceSpeakers: hasAny(managerRoles),
      canViewConferenceRegistrations: hasAny(managerRoles),
      canCreateSurvey: hasAny(managerRoles),
      canManageSurvey: hasAny(managerRoles),
      canViewSurveyResponses: hasAny(managerRoles),
      canViewAuditLogs: hasAny(["super_admin", "org_admin", "vibhag_pramukh", "prant_sanyojak"]),
      canManageOrg: hasAny(["super_admin", "org_admin"]),
    },
