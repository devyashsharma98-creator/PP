...
const PROTECTED_ROUTE_ROLES: Array<{ prefix: string; roles: RoleCode[] }> = [
  ...
  { prefix: "/task-board", roles: DASHBOARD_ROLES },
  { prefix: "/notifications", roles: DASHBOARD_ROLES },
  { prefix: "/circulars", roles: DASHBOARD_ROLES },
  { prefix: "/volunteers", roles: DASHBOARD_ROLES },
  { prefix: "/media", roles: DASHBOARD_ROLES },
  { prefix: "/conferences", roles: DASHBOARD_ROLES },
  { prefix: "/surveys", roles: DASHBOARD_ROLES },
